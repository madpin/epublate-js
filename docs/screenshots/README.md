...
| 13 | `12-settings-llm.png`                 | Settings → LLM      | LLM endpoint card with the Quick presets row (OpenAI/OpenRouter/Ollama), base URL + key + translator/helper model fields, plus Defaults and Pricing.|
